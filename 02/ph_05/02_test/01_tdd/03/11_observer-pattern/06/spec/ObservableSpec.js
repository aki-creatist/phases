describe('', function () {
    ...
    describe('ObservableHasObserverTest', function () {
        it('test should return true when has observer', function () {
            ...
            expect(this.observable.hasObserver(observer)).toBeTruthy();
        });
        ...
        it('test should return true when has observer', function () {
            ...
            this.observable.observe(observers[0]);
            this.observable.observe(observers[1]);
            expect(this.observable.hasObserver(observers[0])).toBeTruthy();
            expect(this.observable.hasObserver(observers[1])).toBeTruthy();
        });
    });
